...
cl %CXX_FLAGS% /Zi whereami.cpp %LINK_LIBRARIES% /link /DEBUG:FULL /INCREMENTAL:NO /SUBSYSTEM:CONSOLE /OUT:whereami_debug.exe

cl %CXX_FLAGS% /O2 whereami.cpp %LINK_LIBRARIES% /link /DEBUG:NONE /INCREMENTAL:NO /SUBSYSTEM:CONSOLE /OUT:whereami.exe
